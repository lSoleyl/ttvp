...
public class Main {
	...
	/**
	 * Anwendung wird wie folgt gestartet: - server [port=4245] - client ip
	 * [port=4245]
	 * 
	 * @param args
	 * @throws Exception
	...
	public static boolean init(String[] args) throws Exception {
		...
		opts.addOption(
				"ip",
				true,
				"Chord Network Bootstrap-Address\nIf not provided, new Chord-Network will be started");
		opts.addOption("port", true,
				"Chord Network local and remote port\nDefault: "
						+ DefaultListenPort);
		...
		RemoteChordNetworkAccess network = RemoteChordNetworkAccess
				.getUniqueInstance();
